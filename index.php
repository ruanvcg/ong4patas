		...
		<nav class="navbar navbar-danger navbar-expand-lg">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					...
					<li class="nav-item header-link">
						<a class="btn btn-light" type="button" href="login.php">Login</a>
					</li>
				</ul>
		</nav>
...
<main>
  <div id="myCarousel" class="carousel slide w-100 carousel-fade" data-bs-ride="carousel">
    ...
    <div class="container">
          <div class="carousel-caption text-start-2">
            <h1 style="text-shadow: -1px -1px 0px black, -1px 1px 0px red, 1px -1px 0px black,1px 0px 0px black;">Estamos precisando de ração</h1>
            <h3 style="text-shadow: -1px -1px 0px black, -1px 1px 0px red, 1px -1px 0px black,1px 0px 0px black;">Estoque para poucos dias!</h3>
	...
	</div><!--  Fim da estruturação dos meios disponíveis para doações -->
...
<div class="container">
  <footer class="py-3 my-5">
    <ul class=" border-bottom nav justify-content-center pb-3 mb-3">
      ...
      <li class="nav-item"><a href="#" class="nav-link px-2 text-muted">Adote</a></li>
      <li class="nav-item"><a href="#" class="nav-link px-2 text-muted">Ajude-nos</a></li>
